    ...
    <div className="flex flex-wrap justify-between">
      ...
      <div className="flex flex-wrap justify-between relative">
        <input
          ...
          className="pl-4 pr-4 py-2 w-100 bg-neutral-light-20 rounded-full shadow-lg text-primary-80 outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white transition-all duration-300"
        />

...
export default function SideBar() {
  ...
  return (
    <aside
      className={`fixed md:flex top-20 left-0 bottom-0 z-30 w-72 transition-all duration-300 bg-neutral-light-40 backdrop-blur-md border border-primary-20 min-h-screen`}
    >

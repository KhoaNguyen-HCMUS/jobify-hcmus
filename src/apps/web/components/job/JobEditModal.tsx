...
export default function JobEditModal({ isOpen, onClose, job, onJobUpdated }: JobEditModalProps) {
              ...
              {companyProfile && (
                <div className="bg-primary-20 p-3 rounded-xl mb-2">
                  <p className="text-primary font-semibold text-sm">
                    Editing job for: <span className="text-secondary">{companyProfile.company_name}</span>
                  </p>

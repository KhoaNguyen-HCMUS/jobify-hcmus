              ...
              <div className="flex flex-col">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-primary border-2 border-primary pl-12 pr-4 py-2 bg-neutral-light-20 rounded-xl text-primary-80 outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white transition-all duration-300"
                    required
                  />
                </div>
              </div>
